...
Theme Name
-------------------------------------------------------------------------------------------------- */
const themeName = 'recontaai-alpha';
...
function devServer() {
	...
	// watch('./src/assets/css/scss/*.scss', stylesSass);
...
// function stylesSass() {
//   return src('./src/assets/css/scss/main.scss')
//     .pipe(sass().on('error', sass.logError))
// 		.pipe(dest('./build/wordpress/wp-content/themes/scss/main-scss.css'))
